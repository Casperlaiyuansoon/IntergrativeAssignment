            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <a href="#" class="btn"
                            onclick="document.getElementById('foodForm').style.display = 'block'">Create Food</a>
                    ...
                    <div id="foodForm" style="display: none;">
                        <form action="adminmenu.php" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" id="foodId"
                                value="<?php echo isset($foodId) ? htmlspecialchars($foodId) : ''; ?>">
                            <label for="name">Food Name:</label>
                            <input type="text" name="name" required
                                value="<?php echo isset($foodName) ? htmlspecialchars($foodName) : ''; ?>">

                            <label for="price">Food Price:</label>
                            <input type="text" name="price" required
                                value="<?php echo isset($foodPrice) ? htmlspecialchars($foodPrice) : ''; ?>">
                            ...
                            <tr>
                                ...
                                <?php foreach ($foodItems as $index => $item): ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="?action=delete&id=<?php echo htmlspecialchars($item['id']); ?>"
                                            class="delete-btn" onclick="return confirmDelete()">
